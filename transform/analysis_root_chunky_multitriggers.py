...
#          if (ran>onlyFraction): continue
       ...
       if (ev ==  NtotInFile or evt%evtINchunk==0):
                     ...
                     for ch in range(nle):
                            ...
                            # cross sections
                            h1x.Fill( ma[0]*CMS_E, we )
                            h2x.Fill( ma[1]*CMS_E, we )
                            h3x.Fill( ma[2]*CMS_E, we )
                            h4x.Fill( ma[3]*CMS_E, we )
                            h5x.Fill( ma[4]*CMS_E, we )
                            # additional masses
                            h6x.Fill( ma[5]*CMS_E, we )
                            h7x.Fill( ma[6]*CMS_E, we  )
                            h8x.Fill( ma[7]*CMS_E, we )
                            h14x.Fill( ma[8]*CMS_E, we )
                            h15x.Fill( ma[9]*CMS_E, we )
                            h11x.Fill(ma[10]*CMS_E, we )
